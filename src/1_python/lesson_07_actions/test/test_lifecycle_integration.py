...
class TestLifecycleIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client_get_state = self.node.create_client(GetState, '/lesson_06_lifecycle_publisher/get_state')
        self.client_change_state = self.node.create_client(ChangeState, '/lesson_06_lifecycle_publisher/change_state')
