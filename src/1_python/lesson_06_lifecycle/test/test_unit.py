"""
Unit tests for Lesson 05 logic and validation.
Run with: pytest src/lesson_05_parameters_py/test/test_logic.py
"""
from lesson_05_parameters_py.logic import StreamEvent, TelemetryStreamValidator, TelemetryGenerator
