...
class LifecyclePublisherNode final : public rclcpp_lifecycle::LifecycleNode {
public:
  explicit LifecyclePublisherNode(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
...
private:
  ...
  std::shared_ptr<TelemetryPublisher> component_;
