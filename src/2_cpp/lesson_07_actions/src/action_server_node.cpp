...
#include "lesson_07_actions/action_server_node.hpp"
#include "lesson_07_actions/utils.hpp"
...
: rclcpp_lifecycle::LifecycleNode("lesson_07_action_server", options),
...
int main(int argc, char ** argv)
{
  ...
  try {
    auto node = std::make_shared<lesson_07_actions_cpp::ActionServerNode>();

    // Lesson 07: deliberate starvation under naive execution.
