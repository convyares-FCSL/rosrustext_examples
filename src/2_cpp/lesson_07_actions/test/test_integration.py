...
def generate_test_description():
    dut_node = LaunchNode(
        ...
        executable="lesson_07_actions_server",
...
class TestActionsIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.target_name = "/lesson_07_action_server"
    ...
    def test_actions_success_cancel_and_starvation(self):
        ...
        # ---- CASE 2: CANCELLATION + starvation probe
        ...
        for _ in range(3):
            ...
            rclpy.spin_until_future_complete(self.node, probe_future, timeout_sec=0.2)
        ...
        self.assertTrue(
            observed_sluggish,
            "Expected lifecycle get_state to be sluggish during action execution",
        )
