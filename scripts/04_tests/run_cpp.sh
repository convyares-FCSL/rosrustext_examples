...
start_node_bg "$LOG_BASE/l01.log" ros2 run lesson_01_node_cpp node
PID=$RET_PID
sleep 2
stop_node $PID
check_ret 0
...
start_node_bg "$LOG_BASE/l02.log" ros2 run lesson_02_publisher_cpp node
PID=$RET_PID
sleep 2
...
start_node_bg "$LOG_BASE/l04.log" ros2 run lesson_04_service_cpp service_server
PID_SRV=$RET_PID
RESP=""
...
start_node_bg "$LOG_BASE/l05.log" ros2 run lesson_05_parameters_cpp lesson_05_publisher_cpp
PID=$RET_PID
VAL=""
...
start_node_bg "$LOG_BASE/l06_pub.log" ros2 run lesson_06_lifecycle_cpp lesson_06_lifecycle_publisher
PID_PUB=$RET_PID
start_node_bg "$LOG_BASE/l06_sub.log" ros2 run lesson_06_lifecycle_cpp lesson_06_lifecycle_subscriber
PID_SUB=$RET_PID
